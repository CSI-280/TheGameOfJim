...
void initSpaceAdventure(unordered_map<string, Room*>* Rooms, unordered_map<string, Link*>* Links)
{
	//Initalize Data
	...
	EmptyLinkToRoom* elToKathor5a = new EmptyLinkToRoom("Empty Link to Kathor5a", kathor5a);
	EmptyLinkToRoom* elToKathor5b = new EmptyLinkToRoom("Empty Link to Kathor5b", kathor5b);
	EmptyLinkToRoom* elToKathor6 = new EmptyLinkToRoom("Empty Link to Kathor6", kathor6);
	EmptyLinkToRoom* elToSpaceShip2 = new EmptyLinkToRoom("Empty Link to Space Ship 2", spaceShip2);
	...
	(*Rooms).insert(pair<string, Room*>((*kathor3).getName(), kathor3));
	(*Rooms).insert(pair<string, Room*>((*kathor4).getName(), kathor4));
	(*Rooms).insert(pair<string, Room*>((*kathor5a).getName(), kathor5a));
	(*Rooms).insert(pair<string, Room*>((*kathor5b).getName(), kathor5b));
	(*Rooms).insert(pair<string, Room*>((*kathor6).getName(), kathor6));
	...
	(*Links).insert(pair<string, Link*>((*elToSpaceShip2).getName(), elToSpaceShip2));
	...
	RoomDescription.push_back("Go back to space ship.");
	...
	RoomDescription.push_back("END OF STORY");
